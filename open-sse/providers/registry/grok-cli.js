...
export default {
  ...
  display: {
    ...
    website: "https://x.ai",
    notice: {
      text: "Sign in with your xAI / Grok account via device code. Uses Grok Build subscription credits (cli-chat-proxy.grok.com). This login can also generate images and videos. Open Media → Text to Image or Video and use the xai/ models.",
